...
DISPLAY_X = CONTROL_PANEL_X + 1300

PRESET_X = CONTROL_PANEL_X + 825  # was effectively 640
...
def draw_header_controls(
    ...
    draw_text(surface, "Presets", small_font, SUBTLE_TEXT, PRESET_X, TOP_ROW_Y - 22)

    # draw_text(surface, "Display", small_font, SUBTLE_TEXT,
    #         CONTROL_PANEL_X + 1080, CONTROL_PANEL_Y + 8)

    draw_text(
        surface, "Display", small_font, SUBTLE_TEXT, DISPLAY_X, CONTROL_PANEL_Y + 8
    )
...
def main():
    ...
    buttons = {
        ...
        "preset_balanced": pygame.Rect(PRESET_X, TOP_ROW_Y - 2, 110, 38),
        "preset_blue": pygame.Rect(PRESET_X + 120, TOP_ROW_Y - 2, 132, 38),
        "preset_yellow": pygame.Rect(PRESET_X + 262, TOP_ROW_Y - 2, 142, 38),
        # Display control (top-right)
        # "toggle_fullscreen": pygame.Rect(CONTROL_PANEL_X + 1080, TOP_ROW_Y, 170, BTN_H),
        "toggle_fullscreen": pygame.Rect(DISPLAY_X, TOP_ROW_Y, 170, BTN_H),
