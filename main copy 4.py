...
def draw_header_controls(surface, fonts, buttons, blue_speed_factor, yellow_speed_factor, paused, show_labels, fullscreen, presentation_mode, auto_demo_mode):
    ...
    draw_button(surface, buttons["play_pause"], button_font, "Play" if paused else "Pause", mouse_pos,
...
def main():
    ...
    buttons = {
        ...
        "toggle_presentation": pygame.Rect(CONTROL_PANEL_X + 1210, CONTROL_PANEL_Y + 58, 126, 34),
        "toggle_auto_demo": pygame.Rect(CONTROL_PANEL_X + 1348, CONTROL_PANEL_Y + 58, 124, 34),
    }
